...
export default function Home({ providers, loading, error, isUsingFallback }: Props) {
  ...
  const filtered = useMemo(() => {
    ...
    return providers.filter(p => {
      ...
      const matchService  = !activeService  || p.services.some(s => s === activeService)
      const matchLocality = !activeLocality || p.localities.some(l => l === activeLocality)
      ...
      <div className="home-body">
        ...
        {isUsingFallback && (
          <div className="fallback-banner">
            Showing sample data — connect your Google Sheet in <code>src/config.ts</code>
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="empty-state">
            ...
            <p className="empty-sub">Try a different search or remove a filter.</p>
          </div>
        ) : (
